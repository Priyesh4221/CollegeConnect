...
//  Collegeconnect
//
//  Created by PRIYESH  on 11/16/19.
...
class Circularloader: UIView {
    ...
    private func drawBackgroundLayer(){
        ...
        self.backgroundLayer.strokeColor = #colorLiteral(red: 0.927175343, green: 0.9534731507, blue: 0.9783319831, alpha: 1)
    ...
    private func drawForegroundLayer(){
        ...
        foregroundLayer.strokeColor = #colorLiteral(red: 0.3411764706, green: 0.6470588235, blue: 0.8705882353, alpha: 1)
    ...
    private func setForegroundLayerColorForSafePercent(){
        if Int(label.text!)! >= self.safePercent {
            ...
            self.foregroundLayer.strokeColor = #colorLiteral(red: 0.3411764706, green: 0.6470588235, blue: 0.8705882353, alpha: 1)
        }
    }
